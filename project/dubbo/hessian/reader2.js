 ...
 *
 ...
 由于 hessian头中长度位是按<字符数>而不是<字节数>给出的 见java代码
 public void writeString(String value){
    .....
    int length = value.length();//获取了string的长度 即字符数
    ......
    printString(value, strOffset, length);//end
 }
 原版的readString根据长度读取指定字节数,在多字节语言的解码过程中会有问题.
 所以增加了这个玩意
